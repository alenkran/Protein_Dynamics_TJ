...
#################
#set a job name  
#SBATCH --job-name=pop_sample
#################  
#a file for job output, you can check job progress, append the job ID with %j to make it unique
#SBATCH --output=/scratch/users/cachoe/job_outputs/pop_sample.%j.out
#################
# a file for errors from the job
#SBATCH --error=/scratch/users/cachoe/job_outputs/pop_sample.%j.err
#################
...
#python population_sample.py -num_clusters 100 -dataset fspeptide
source deactivate