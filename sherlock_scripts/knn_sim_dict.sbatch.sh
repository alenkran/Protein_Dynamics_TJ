...
#################
#set a job name  
#SBATCH --job-name=knn_sim_dict
#################  
#a file for job output, you can check job progress, append the job ID with %j to make it unique
#SBATCH --output=/scratch/users/cachoe/job_outputs/knn_sim_dict.%j.out
#################
# a file for errors from the job
#SBATCH --error=/scratch/users/cachoe/job_outputs/knn_sim_dict.%j.err
#################
