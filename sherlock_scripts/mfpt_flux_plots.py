...
# Usage: python mfpt_plots.py -n_neighbors <n_neighbors> -n_components <n_components> -num_clusters <num_clusters> -dataset <dataset label> -method <method name>
...
# Example: python mfpt_flux_plots.py -n_neighbors 30 -n_components 40 -num_clusters 97 -dataset fspeptide -technique isomap
