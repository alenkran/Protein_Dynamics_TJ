...
#################
#set a job name  
#SBATCH --job-name=isomap_cluster_dev
#################  
#a file for job output, you can check job progress, append the job ID with %j to make it unique
#SBATCH --output=/scratch/users/mincheol/job_outputs/isomap_cluster_dev_output.%j.out

#################
# a file for errors from the job
#SBATCH --error=/scratch/users/mincheol/job_outputs/isomap_cluster_dev_output.%j.err
...
# sherlock automatically allocates 4 Gigs of RAM/CPU, if you ask for 8 CPUs you will need 32 Gigs of RAM, so either 
...
python isomap_clustering.py -n_neighbors 300 -n_components 20 -num_clusters 200 -dataset calmodulin -sample_rate 0.6
source deactivate